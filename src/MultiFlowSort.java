...
public class MultiFlowSort 
{
	...
	public static void integerMode(MultiFlowSort fs)
	{
		...
		System.out.println((comparlog/(timelist.size()-1)) + " Logarithmic k for comparisons");
		System.out.println((swaplog/(timelist.size()-1)) + " Logarithmic k for swaps");
